...
;
  Global MTXInitialized.l
  ;
; *************************************************************************************** Start()
ProcedureCDLL AConstructor00YAXXZ()
  If MTXInitialized = 0
    MTXInitialized = InitDLLBase()
   EndIf
...
ProcedureCDLL.s AGetDependencyID00YAPBDH0Z( NumID.l )
 ...
 EndProcedure
; **************************************************************
ProcedureCDLL.l MTX_Init()
  If MTXInitialized = 0
    MTXInitialized = InitDLLBase()
   EndIf
  If *GlobPtr = 0 : InitialiseCorePtr() : EndIf
  ProcedureReturn MTXInitialized
 EndProcedure
;
; **************************************************************
; **************************************************************
  IncludeFile "DBProMatrixDynamic.pb"
; **************************************************************
; **************************************************************
; **************************************************************
...
Data.b 0
DEP_DBPRO01:
Data.s "DBProMatrixDebug.dll"
Data.b 0
Data.s "DarkBasic Professional Extends Pack Ver 1.6 / "
Data.s "DBProMatrixExtends.dll Ver 1.6 [ 2012.06.27 ]  / "
...
; FirstLine = 33
; Folding = -
; Executable = eXtends_Matrixes3D.dll
; DisableDebugger
; AddResource = Matrix.rc