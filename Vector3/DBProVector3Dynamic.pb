...
ProcedureCDLL V3D3_Clear()
 ...
 EndProcedure
; ***************************************************************************************
ProcedureCDLL.l V3D3_GetFree()
  If V3D3Initialized = 1
...
ProcedureCDLL.l V3D3_Delete( Number.l )
 ...
 EndProcedure
; ***************************************************************************************
ProcedureCDLL.l V3D3_DynamicMakeVector3()
  If V3D3Initialized = 1
    Target.l = DLH_GetNextFreeItem()
    Null.l = DBMakeVector3( Target )
   Else
    Target = 0
   EndIf
