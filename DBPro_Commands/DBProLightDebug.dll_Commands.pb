...
Procedure DBPointLight( LightNumber.l, X.f, Y.f, Z.f )
  ...
  CallCFunctionFast( *DB_Light\Point, LightNumber, X1, Y1, Z1 )
 EndProcedure
;
; *********************************************************************
Procedure DBPositionLight( LightNumber.l, X.f, Y.f, Z.f )
  X1.l = 0 : Y1.l = 0 : Z1.l = 0
  PokeF( @X1, X ) : PokeF( @Y1, Y ) : PokeF( @Z1, Z )
  CallCFunctionFast( *DB_Light\Position, LightNumber, X1, Y1, Z1 )
 EndProcedure
;
; *********************************************************************
Procedure DBRotateLight( LightNumber.l, XAngle.f, YAngle.f, ZAngle.f )
  ...
  CallCFunctionFast( *DB_Light\Rotate, LightNumber, X1, Y1, Z1 )
 EndProcedure
;
; *********************************************************************
Procedure DBSetDirectional( LightNumber.l, NX.f, NY.f, NZ.f )
  X1.l = 0 : Y1.l = 0 : Z1.l = 0
  PokeF( @X1, NX ) : PokeF( @Y1, NY ) : PokeF( @Z1, NZ )
  CallCFunctionFast( *DB_Light\SetDirectional, LightNumber, X1, Y1, Z1 )
 EndProcedure
;
; *********************************************************************
Procedure DBSetLightRange( LightNumber.l, Distance.f )
  D.l = 0 : PokeF( @D, Distance )
  CallCFunctionFast( *DB_Light\SetRange, LightNumber, D )
 EndProcedure
;
; *********************************************************************
...
Procedure DBSetPointLight( LightNumber.l, X.f, Y.f, Z.f )
  X1.l = 0 : Y1.l = 0 : Z1.l = 0
  PokeF( @X1, X ) : PokeF( @Y1, Y ) : PokeF( @Z1, Z )
  CallCFunctionFast( *DB_Light\SetPoint, LightNumber, X1, Y1, Z1 )
 EndProcedure
;
; *********************************************************************
Procedure DBSetSpotLight( LightNumber.l, InnerAngle.f, OuterAngle.f )
  IA.l = 0 : OA.l = 0
  PokeF( @IA, InnerAngle ) : PokeF( @OA, OuterAngle )
  CallCFunctionFast( *DB_Light\SetSpot, LightNumber, IA, OA )
 EndProcedure
;
; *********************************************************************
