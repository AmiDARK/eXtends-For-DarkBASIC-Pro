...
Procedure DBScaleSprite( SpriteNumber.l, Scale.f )
  S.l = 0 : PokeF( @S, Scale )
  CallCFunctionFast( *DB_Sprites\Scale, SpriteNumber, S )
 EndProcedure
;
; *********************************************************************
...
Procedure DBRotateSprite( SpriteNumber.l, Angle.f )
  A.l = 0 : PokeF( @A, Angle )
  CallCFunctionFast( *DB_Sprites\Rotate, SpriteNumber, A )
 EndProcedure
;
; *********************************************************************
...
Procedure DBSetTextureCoordinates( SpriteNumber.l, VertexIndex.l, UValue.f, VValue.f )
  UV.l = 0 : VV.l = 0
  PokeF( @UV, UValue ) : PokeF( @VV, VValue )
  CallCFunctionFast( *DB_Sprites\SetTextureCoordinates, SpriteNumber, VertexIndex, UV, VV )
 EndProcedure
;
; *********************************************************************
...
Procedure DBMoveSprite( SpriteNumber.l, Velocity.f )
  V.l = 0 : PokeF( @V, Velocity )
  CallCFunctionFast( *DB_Sprites\Move, SpriteNumber, V )
 EndProcedure
;
; *********************************************************************
