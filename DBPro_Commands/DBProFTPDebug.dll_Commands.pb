...
Procedure.s DBGetFTPDir()
  Retour.l = CallCFunctionFast( *DB_FTP\GetDir, 0 )
...
Procedure.s DBGetFTPError()
  Retour.l = CallCFunctionFast( *DB_FTP\GetError, 0 )
  RetourSTR.s = PeekS( Retour )
  CallCFunctionFast( *GlobPtr\CreateDeleteString, Retour, 0 )
  ProcedureReturn RetourSTR
 EndProcedure
...
Procedure.s DBGetFTPFileName()
  Retour.l = CallCFunctionFast( *DB_FTP\GetFileName, 0 )
  RetourSTR.s = PeekS( Retour )
  CallCFunctionFast( *GlobPtr\CreateDeleteString, Retour, 0 )
  ProcedureReturn RetourSTR
 EndProcedure
...
Procedure.s DBHTTPRequestData( Verb.s, Object.s, StringToSend.s )
  ...
  Retour.l = CallCFunctionFast( *DB_FTP\HTTPRequestData, 0, VerbPTR, ObjectPTR, StringToSendPTR )
  RetourSTR.s = PeekS( Retour )
  CallCFunctionFast( *GlobPtr\CreateDeleteString, Retour, 0 )
  ProcedureReturn RetourSTR
 EndProcedure
