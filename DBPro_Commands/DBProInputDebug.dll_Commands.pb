...
Procedure.s DBGetClipboard()
  Retour.l = CallCFunctionFast( *DB_Input\GetClipboard, 0 )
  If Retour <> 0
...
Procedure.s DBGetEntry()
  Retour.l = CallCFunctionFast( *DB_Input\GetEntry, 0 )
  If retour <> 0
    RetourSTR.s = PeekS( Retour )
    CallCFunctionFast( *GlobPtr\CreateDeleteString, Retour, 0 )
   Else
...
Procedure.s DBGetControlDevice()
  Retour.l = CallCFunctionFast( *DB_Input\GetControlDevice, 0 )
  If Retour <> 0
    RetourSTR.s = PeekS( Retour )
    CallCFunctionFast( *GlobPtr\CreateDeleteString, Retour, 0 )
   Else
...
Procedure.s DBGetRegistryS( FolderName.s, KeyName.s )
  ...
  CallCFunctionFast( *GlobPtr\CreateDeleteString, @KeyNamePTR.l, Len( KeyName ) + 1 ) ; CreateString
  PokeS( KeyNamePTR, KeyName )
  Retour.l = CallCFunctionFast( *DB_Input\GetRegistryS, 0, FolderNamePTR, KeyNamePTR )
  If Retour <> 0
    RetourSTR.s = PeekS( Retour )
    CallCFunctionFast( *GlobPtr\CreateDeleteString, Retour, 0 )
   Else
...
Procedure.s DBGetEntry1( AutoBackspaceMode.l )
  Retour.l = CallCFunctionFast( *DB_Input\GetEntryEx, 0, AutoBackspaceMode )
  If Retour <> 0
    RetourSTR.s = PeekS( Retour )
    CallCFunctionFast( *GlobPtr\CreateDeleteString, Retour, 0 )
   Else
