...
Procedure DBLoadObject( Filename.s, ObjectNumber.l )
  If TextureQuality = 0
   ...
   Else
    TextureMODE.l = TextureQuality * 2
    CallCFunctionFast( *GlobPtr\CreateDeleteString, @FilenamePTR.l, Len( Filename ) + 1 ) ; CreateString
    PokeS( FilenamePTR, Filename )
    CallCFunctionFast( *DB_Basic3D\Load2, FilenamePTR, ObjectNumber, 0, TextureQuality )
   EndIf
 EndProcedure
; *********************************************************************
Procedure DBLoadObjectEx( Filename.s, ObjectNumber.l, DBProMode.l )
  If TextureQuality = 0
    CallCFunctionFast( *GlobPtr\CreateDeleteString, @FilenamePTR.l, Len( Filename ) + 1 ) ; CreateString
    PokeS( FilenamePTR, Filename )
    CallCFunctionFast( *DB_Basic3D\Load1, FilenamePTR, ObjectNumber, 0 )
   Else
    TextureMODE.l = TextureQuality * 2
    CallCFunctionFast( *GlobPtr\CreateDeleteString, @FilenamePTR.l, Len( Filename ) + 1 ) ; CreateString
    PokeS( FilenamePTR, Filename )
...
Procedure DBRotateObject( ObjectNumber.l, XAngle.f, YAngle.f, ZAngle.f )
  X.l = 0 : Y.l = 0 : Z.l = 0
  PokeF( @X, XAngle ) : PokeF( @Y, YAngle ) : PokeF( @Z, ZAngle )
  CallCFunctionFast( *DB_Basic3D\Rotate, ObjectNumber, X, Y, Z )
 EndProcedure
;
; *********************************************************************
...
Procedure DBFadeObject( ObjectNumber.l, FadeValue.f )
  F.l = 0
  PokeF( @F, FadeValue )
  CallCFunctionFast( *DB_Basic3D\Fade, ObjectNumber, F )
 EndProcedure
;
; *********************************************************************
...
Procedure.s DBGetLimbName( ObjectNumber.l, LimbNumber.l )
  Retour.l = CallCFunctionFast( *DB_Basic3D\GetLimbName, 0, ObjectNumber, LimbNumber )
  If Retour <> 0
...
Procedure.s DBGetLimbTextureName( ObjectNumber.l, LimbNumber.l )
  Retour.l = CallCFunctionFast( *DB_Basic3D\GetLimbTextureName, 0, ObjectNumber, LimbNumber )
  If Retour <> 0
    RetourSTR.s = PeekS( Retour )
    CallCFunctionFast( *GlobPtr\CreateDeleteString, Retour, 0 )
   Else
...
Procedure DBMakeObjectBox( ObjectNumber.l, Width.f, Height.f, Depth.f )
  ...
  CallCFunctionFast( *DB_Basic3D\MakeBox, ObjectNumber, W, H, D )
 EndProcedure
;
; *********************************************************************
Procedure DBMakeObjectCollisionBox( ObjectNumber.l, X1.f, Y1.f, Z1.f, X2.f, Y2.f, Z2.f, CollisionFlag.l )
  FX1.l = 0 : FY1.l = 0 : FZ1.l = 0 : FX2.l = 0 : FY2.l = 0 : FZ2.l = 0
  PokeF( @FX1, X1 ) : PokeF( @FY1, Y1 ) : PokeF( @FZ1, Z1 )
  PokeF( @FX2, X2 ) : PokeF( @FY2, Y2 ) : PokeF( @FZ2, Z2 )
  CallCFunctionFast( *DB_Basic3D\MakeCollisionBox, ObjectNumber, FX1, FY1, FZ1, FX2, FY2, FZ2, CollisionFlag )
 EndProcedure
;
; *********************************************************************
Procedure DBMakeObjectCone( ObjectNumber.l, Size.f )
  FSize.l = 0 : PokeF( @FSize, Size )
  CallCFunctionFast( *DB_Basic3D\MakeCone, ObjectNumber, FSize )
 EndProcedure
;
; *********************************************************************
Procedure DBMakeObjectCube( ObjectNumber.l, Size.f )
  S.l = 0 : PokeF( @S, Size )
  CallCFunctionFast( *DB_Basic3D\MakeCube, ObjectNumber, S)
 EndProcedure
;
; *********************************************************************
Procedure DBMakeObjectCylinder( ObjectNumber.l, Size.f )
  S.l = 0 : PokeF( @S, Size )
  CallCFunctionFast( *DB_Basic3D\MakeCylinder, ObjectNumber, S )
 EndProcedure
;
; *********************************************************************
...
;
; *********************************************************************
Procedure DBMakeObjectFromLimb( ObjectNumber.l, SecondObject.l, LimbNumber.l )
...
Procedure DBMakeObjectPlane( ObjectNumber.l, Width.f, Height.f )
  W.l = 0 : H.l = 0 : PokeF( @W, Width ) : PokeF( @H, Height )
  CallCFunctionFast( *DB_Basic3D\MakePlane, ObjectNumber, W, H )
 EndProcedure
;
; *********************************************************************
Procedure DBMakeObjectSphere( ObjectNumber.l, Size.f )
  S.l = 0 : PokeF( @S, Size)
  CallCFunctionFast( *DB_Basic3D\MakeSphere, ObjectNumber, S )
 EndProcedure
;
; *********************************************************************
Procedure DBMakeObjectTriangle( ObjectNumber.l, X1.f, Y1.f, Z1.f, X2.f, Y2.f, Z2.f, X3.f, Y3.f, Z3.f )
  FX1.l = 0 : FY1.l = 0 : FZ1.l = 0 : FX2.l = 0 : FY2.l = 0 : FZ2.l = 0 : FX3.l = 0 : FY3.l = 0 : FZ3.l = 0
  PokeF( @FX1, X1 ) : PokeF( @FY1, Y1 ) : PokeF( @FZ1, Z1 )
  PokeF( @FX2, X2 ) : PokeF( @FY2, Y2 ) : PokeF( @FZ2, Z2 )
  PokeF( @FX3, X3 ) : PokeF( @FY3, Y3 ) : PokeF( @FZ3, Z3 )
...
Procedure DBMoveObject( ObjectNumber.l, Speed.f )
  S.l = 0 : PokeF( @S, Speed )
  CallCFunctionFast( *DB_Basic3D\Move, ObjectNumber, S )
 EndProcedure
;
; *********************************************************************
Procedure DBOffsetLimb( ObjectNumber.l, LimbNumber.l, X.f, Y.f, Z.f )
  ...
  CallCFunctionFast( *DB_Basic3D\OffsetLimb, ObjectNumber, LimbNumber, X1, Y1, Z1 )
 EndProcedure
;
; *********************************************************************
...
Procedure DBPitchObjectDown( ObjectNumber.l, Value.f )
  V.l = 0 : PokeF( @V, Value )
  CallCFunctionFast( *DB_Basic3D\PitchDown, ObjectNumber, V )
 EndProcedure
;
; *********************************************************************
Procedure DBPitchObjectUp( ObjectNumber.l, Value.f )
  V.l = 0 : PokeF( @V, Value )
  CallCFunctionFast( *DB_Basic3D\PitchUp, ObjectNumber, V )
 EndProcedure
;
; *********************************************************************
...
Procedure DBPointObject( ObjectNumber.l, X.f, Y.f, Z.f )
  X1.l = 0 : Y1.l = 0 : Z1. l = 0
  PokeF( @X1, X ) : PokeF( @Y1, Y ) : PokeF( @Z1, Z )
  CallCFunctionFast( *DB_Basic3D\Point, ObjectNumber, X1, Y1, Z1 )
 EndProcedure
 ;
; *********************************************************************
Procedure DBPositionObject( ObjectNumber.l, X.f, Y.f, Z.f )
  X1.l = 0 : Y1.l = 0 : Z1. l = 0
  PokeF( @X1, X ) : PokeF( @Y1, Y ) : PokeF( @Z1, Z )
  CallCFunctionFast( *DB_Basic3D\Position, ObjectNumber, X1, Y1, Z1 )
 EndProcedure
;
; *********************************************************************
Procedure DBRollObjectLeft( ObjectNumber.l, Value.f )
  V.l = 0 : PokeF( @V, Value )
  CallCFunctionFast( *DB_Basic3D\RollLeft, ObjectNumber, V )
 EndProcedure
;
; *********************************************************************
Procedure DBRollObjectRight( ObjectNumber.l, Value.f )
  V.l = 0 : PokeF( @V, Value )
  CallCFunctionFast( *DB_Basic3D\RollRight, ObjectNumber, V )
 EndProcedure
;
; *********************************************************************
Procedure DBMakeObjectObjectPlane1( ObjectNumber.l, Width.f, Height.f, Param3.l )
  W.l = 0 : H.l = 0
  PokeF( @W, Width ) : PokeF( @H, Height )
  CallCFunctionFast( *DB_Basic3D\MakePlane1, ObjectNumber, W, H, Param3 )
 EndProcedure
;
; *********************************************************************
Procedure DBRotateLimb( ObjectNumber.l, LimbNumber.l, XAngle.f, YAngle.f, ZAngle.f )
  XA.l = 0 : YA.l = 0 : ZA.l = 0
  PokeF( @XA, XAngle ) : PokeF( @YA, YAngle ) : PokeF( @ZA, ZAngle )
  CallCFunctionFast( *DB_Basic3D\RotateLimb, ObjectNumber, LimbNumber, XA, YA, ZA )
 EndProcedure
;
; *********************************************************************
...
Procedure DBScaleObject( ObjectNumber.l, XSize.f, YSize.f, ZSize.f )
  FXSize.l = 0 : FYSize.l = 0 : FZSize.l = 0
  PokeF( @FXSize, XSize ) : PokeF( @FYSize, YSize ) : PokeF( @FZSize, ZSize )
  CallCFunctionFast( *DB_Basic3D\Scale, ObjectNumber, FXSize, FYSize, FZSize )
 EndProcedure
;
; *********************************************************************
Procedure DBScaleLimb( ObjectNumber.l, LimbNumber.l, XSize.f, YSize.f, ZSize.f )
  XS.l = 0 : YS.l = 0 : ZS.l = 0
  PokeF( @XS, XSize ) : PokeF( @YS, YSize ) : PokeF( @ZS, ZSize )
  CallCFunctionFast( *DB_Basic3D\ScaleLimb, ObjectNumber, LimbNumber, XS, YS, ZS )
 EndProcedure
;
; *********************************************************************
Procedure DBScaleLimbTexture( ObjectNumber.l, LimbNumber.l, UScale.f, VScale.f )
  US.l = 0 : VS.l = 0
  PokeF( @US, UScale ) : PokeF( @VS, VScale )
  CallCFunctionFast( *DB_Basic3D\ScaleLimbTexture, ObjectNumber, LimbNumber, US, VS )
 EndProcedure
;
; *********************************************************************
Procedure DBScaleTexture( ObjectNumber.l, UScale.f, VScale.f )
  US.l = 0 : VS.l = 0
  PokeF( @US, UScale ) : PokeF( @VS, VScale )
  CallCFunctionFast( *DB_Basic3D\ScaleTexture, ObjectNumber, US, VS )
 EndProcedure
;
; *********************************************************************
Procedure DBScrollLimbTexture( ObjectNumber.l, LimbNumber.l, X.f, Y.f )
  ...
  CallCFunctionFast( *DB_Basic3D\ScrollLimbTexture, ObjectNumber, LimbNumber, X1, Y1 )
 EndProcedure
;
; *********************************************************************
Procedure DBScrollTexture( ObjectNumber.l, X.f, Y.f )
  X1.l = 0 : Y1.l = 0
  PokeF( @X1, X ) : PokeF( @Y1, Y )
  CallCFunctionFast( *DB_Basic3D\ScrollTexture, ObjectNumber, X1, Y1 )
 EndProcedure
 ;
; *********************************************************************
...
Procedure DBSetObjectFrame( ObjectNumber.l, Frame.f )
  F.l = 0 : PokeF( @F, Frame )
  CallCFunctionFast( *DB_Basic3D\SetFrameEx, ObjectNumber, F )
 EndProcedure
;
; *********************************************************************
...
Procedure DBTurnObjectLeft( ObjectNumber.l, Value.f )
  V.l = 0 : PokeF( @V, Value )
  CallCFunctionFast( *DB_Basic3D\TurnLeft, ObjectNumber, V )
 EndProcedure
;
; *********************************************************************
Procedure DBTurnObjectRight( ObjectNumber.l, Value.f )
  V.l = 0 : PokeF( @V, Value )
  CallCFunctionFast( *DB_Basic3D\TurnRight, ObjectNumber, V )
 EndProcedure
;
; *********************************************************************
...
Procedure DBXRotate( ObjectNumber.l, XAngle.f )
  X.l = 0 : PokeF( @X, XAngle )
  CallCFunctionFast( *DB_Basic3D\XRotate, ObjectNumber, X )
 EndProcedure
;
; *********************************************************************
Procedure DBYRotate( ObjectNumber.l, YAngle.f )
  Y.l = 0 : PokeF( @Y, YAngle )
  CallCFunctionFast( *DB_Basic3D\YRotate, ObjectNumber, Y )
 EndProcedure
;
; *********************************************************************
Procedure DBZRotate( ObjectNumber.l, ZAngle.f )
  Z.l = 0 : PokeF( @Z, ZAngle )
  CallCFunctionFast( *DB_Basic3D\ZRotate, ObjectNumber, Z )
 EndProcedure
;
; *********************************************************************
...
Procedure DBMakeObjectObjectSphere1( ObjectNumber.l, Size.f, Rows.l, Columns.l )
  S.l = 0 : PokeF( @S, Size )
  CallCFunctionFast( *DB_Basic3D\MakeSphere1, ObjectNumber, S, Rows, Columns )
 EndProcedure
;
; *********************************************************************
Procedure DBMoveObjectDown( ObjectNumber.l, Value.f )
  V.l = 0 : PokeF( @V, Value )
  CallCFunctionFast( *DB_Basic3D\MoveDown, ObjectNumber, V )
 EndProcedure
;
; *********************************************************************
Procedure DBMoveObjectLeft( ObjectNumber.l, Value.f )
  V.l = 0 : PokeF( @V, Value )
  CallCFunctionFast( *DB_Basic3D\MoveLeft, ObjectNumber, V )
 EndProcedure
;
; *********************************************************************
Procedure DBMoveObjectRight( ObjectNumber.l, Value.f )
  V.l = 0 : PokeF( @V, Value )
  CallCFunctionFast( *DB_Basic3D\MoveRight, ObjectNumber, V )
 EndProcedure
;
; *********************************************************************
Procedure DBMoveObjectUp( ObjectNumber.l, Value.f )
  V.l = 0 : PokeF( @V, Value )
  CallCFunctionFast( *DB_Basic3D\MoveUp, ObjectNumber, V )
 EndProcedure
;
; *********************************************************************
...
Procedure DBSetSphereRadius( ObjectNumber.l, Radius.f )
  ...
  CallCFunctionFast( *DB_Basic3D\SetSphereRadius, ObjectNumber, R )
 EndProcedure
;
; *********************************************************************
...
Procedure DBScaleTexture1( ObjectNumber.l, Stage.l, UScale.f, VScale.f )
  US.l = 0 : VS.l = 0
  PokeF( @US, UScale ) : PokeF( @VS, VScale )
  CallCFunctionFast( *DB_Basic3D\ScaleTexture1, ObjectNumber, Stage, USc, VS )
 EndProcedure
;
; *********************************************************************
...
Procedure.f DBIntersectObject( ObjectNumber.l, X.f, Y.f, Z.f, ToX.f, ToY.f, ToZ.f )
  X1.l = 0 : Y1.l = 0 : Z1.l = 0 : ToX1.l = 0 : ToY1.l = 0 : ToZ1.l = 0
  PokeF( @X1, X ) : PokeF( @Y1, Y ) : PokeF( @Z1, Z )
  PokeF( @ToX1, ToX ) : PokeF( @ToY1, ToY ) : PokeF( @ToZ1, ToZ )
  Retour.l = CallCFunctionFast( *DB_Basic3D\IntersectObject, ObjectNumber, X1, Y1, Z1, ToX1, ToY1, ToZ1 )
  RetourFLT.f = PeekF( @Retour )
  ProcedureReturn RetourFLT
 EndProcedure
;
...
Procedure DBAutomaticObjectCollision( ObjectNumber.l, Radius.f, Response.l )
  R.l = 0 : PokeF( @R, Radius )
  CallCFunctionFast( *DB_Basic3D\AutomaticObjectCollision, ObjectNumber, R, Response )
 EndProcedure
;
; *********************************************************************
Procedure DBAutomaticCameraCollision( CameraNumber.l, Radius.f, Response.l )
  R.l = 0 : PokeF( @R, Radius )
  CallCFunctionFast( *DB_Basic3D\AutomaticCameraCollision, CameraNumber, R, Response )
 EndProcedure
;
; *********************************************************************
...
Procedure DBSetLimbSmoothing( ObjectNumber.l, LimbNumber.l, Percentage.f )
  ...
  CallCFunctionFast( *DB_Basic3D\SetLimbSmoothing, ObjectNumber, LimbNumber, P )
 EndProcedure
;
; *********************************************************************
...
Procedure DBSetVertexDataUV( VertexIndex.l, U.f, V.f )
  U1.l = 0 : V1.l = 0
  PokeF( @U1, U ) : PokeF( @V1, V )
  CallCFunctionFast( *DB_Basic3D\SetVertexDataUV, VertexIndex, U1, V1 )
 EndProcedure
;
; *********************************************************************
Procedure DBSetVertexDataNormals( VertexIndex.l, NX.f, NY.f, NZ.f )
  NX1.l = 0 : NY1.l = 0 : NZ1.l = 0
  PokeF( @NX1, NX ) : PokeF( @NY1, NY ) : PokeF( @NZ1, NZ )
  CallCFunctionFast( *DB_Basic3D\SetVertexDataNormals, VertexIndex, NX1, NY1, NZ1 )
 EndProcedure
;
; *********************************************************************
Procedure DBSetObjectaPosition( VertexIndex.l, X.f, Y.f, Z.f )
  X1.l = 0 : Y1.l = 0 : Z1.l = 0
  PokeF( @X1, X ) : PokeF( @Y1, Y ) : PokeF( @Z1, Z )
  CallCFunctionFast( *DB_Basic3D\SetVertexDataPosition, VertexIndex, X1, Y1, Z1 )
 EndProcedure
;
; *********************************************************************
...
Procedure DBSetAlphaFactor( ObjectNumber.l, AlphaPercentage.f )
  AP.l = 0 : PokeF( @AP, AlphaPercentage )
  CallCFunctionFast( *DB_Basic3D\SetAlphaFactor, ObjectNumber, AP )
 EndProcedure
;
; *********************************************************************
...
Procedure DBSetEffectConstantF( EffectNumber.l, ConstantString.s, ConstantValue.f )
  ...
  CallCFunctionFast( *DB_Basic3D\SetEffectConstantF, EffectNumber, ConstantStringPTR, CV )
 EndProcedure
;
; *********************************************************************
...
Procedure DBPickScreen2D23D( ScreenX.l, ScreenY.l, Distance.f )
  D.l = 0 : PokeF( @D, Distance )
  CallCFunctionFast( *DB_Basic3D\PickScreen2D23D, ScreenX, ScreenY, D )
 EndProcedure
;
; *********************************************************************
...
Procedure DBSetVertexDataUV1( VertexIndex.l, Index.l, U.f, V.f )
  U1.l = 0 : V1.l = 0
  PokeF( @U1, U ) : PokeF( @V1, V )
  CallCFunctionFast( *DB_Basic3D\SetVertexDataUV1, VertexIndex, Index, U1, V1 )
 EndProcedure
;
; *********************************************************************
...
Procedure DBSetObjectFOV( ObjectNumber.l, FOVAngle.f )
  FOVA.l = 0 : PokeF( @FOVA, FOVAngle )
  CallCFunctionFast( *DB_Basic3D\SetObjectFOV, ObjectNumber, FOVA )
 EndProcedure
;
; *********************************************************************
...
Procedure DBEnableObjectZBias( ObjectNumber.l, SlopeScale.f, Depth.f )
  SS.l = 0 : D.l = 0
  PokeF( @SS, SlopeScale ) : PokeF( @D, Depth )
  CallCFunctionFast( *DB_Basic3D\EnableZBias, ObjectNumber, SS, D )
 EndProcedure
;
; *********************************************************************
...
Procedure DBOffsetLimb1( ObjectNumber.l, LimbNumber.l, X.f, Y.f, Z.f, BoundsFlag.l )
  X1.l = 0 : Y1.l = 0 : Z1.l = 0
  PokeF( @X1, X ) : PokeF( @Y1, Y ) : PokeF( @Z1, Z )
  CallCFunctionFast( *DB_Basic3D\OffsetLimb1, ObjectNumber, LimbNumber, X1, Y1, Z1, BoundsFlag )
 EndProcedure
;
; *********************************************************************
Procedure DBScaleLimb1( ObjectNumber.l, LimbNumber.l, XSize.f, YSize.f, ZSize.f, BoundsFlag.l )
  X1.l = 0 : Y1.l = 0 : Z1.l = 0
  PokeF( @X1, XSize ) : PokeF( @Y1, YSize ) : PokeF( @Z1, ZSize )
  CallCFunctionFast( *DB_Basic3D\ScaleLimb1, ObjectNumber, LimbNumber, X1, Y1, Z1, BoundsFlag )
 EndProcedure
;
; *********************************************************************
Procedure DBRotateLimb1( ObjectNumber.l, LimbNumber.l, XAngle.f, YAngle.f, ZAngle.f, BoundsFlag.l )
  ...
  CallCFunctionFast( *DB_Basic3D\RotateLimb1, ObjectNumber, LimbNumber, X1, Y1, Z1, BoundsFlag )
 EndProcedure
;
; *********************************************************************
...
Procedure DBSetObjectFrame1( ObjectNumber.l, Frame.f, RecalculateBounds.l )
  F.l = 0 : PokeF( @F, Frame )
  CallCFunctionFast( *DB_Basic3D\SetFrameEx1, ObjectNumber, F, RecalculateBounds )
 EndProcedure
;
; *********************************************************************
...
Procedure DBScrollTexture1( ObjectNumber.l, Stage.l, X.f, Y.f )
  X1.l = 0 : Y1.l = 0
  PokeF( @X1, X ) : PokeF( @Y1, Y )
  CallCFunctionFast( *DB_Basic3D\ScrollTexture1, ObjectNumber, Stage, X1, Y1 )
 EndProcedure
;
; *********************************************************************
Procedure DBScaleLimbTexture1( ObjectNumber.l, LimbNumber.l, Stage.l, UScale.f, VScale.f )
  U.l = 0 : V.l = 0
  PokeF( @U1, UScale ) : PokeF( @V1, VScale )
  CallCFunctionFast( *DB_Basic3D\ScaleLimbTexture1, ObjectNumber, LimbNumber, Stage, U1, V1 )
 EndProcedure
;
; *********************************************************************
Procedure DBScrollLimbTexture1( ObjectNumber.l, LimbNumber.l, Stage.l, X.f, Y.f )
  X1.l = 0 : Y1.l = 0
  PokeF( @X1, X ) : PokeF( @Y1, Y )
  CallCFunctionFast( *DB_Basic3D\ScrollLimbTexture1, ObjectNumber, LimbNumber, Stage, X1, Y1 )
 EndProcedure
;
; *********************************************************************
...
Procedure.s DBGetLimbTextureName1( ObjectNumber.l, LimbNumber.l, TextureStage.l )
  Retour.l = CallCFunctionFast( *DB_Basic3D\GetLimbTextureNameEx, 0, ObjectNumber, LimbNumber, TextureStage )
  If Retour <> 0
    RetourSTR.s = PeekS( Retour )
    CallCFunctionFast( *GlobPtr\CreateDeleteString, Retour, 0 )
   Else
...
;
; *********************************************************************
Procedure DBMakeObjectFromLimb1( ObjectNumber.l, SecondObject.l, LimbNumber.l, AllLimbsFlag.l )
...
;
; *********************************************************************
Procedure DBPerformChecklistForObjectLimbs( ObjectNumber.l )
  CallCFunctionFast( *DB_Basic3D\PerformChecklistForObjectLimbs, ObjectNumber )
 EndProcedure
;
; *********************************************************************
Procedure DBLockVertexDataForLimb( ObjectNumber.l, LimbNumber.l )
  CallCFunctionFast( *DB_Basic3D\LockVertexDataForLimb, ObjectNumber, LimbNumber )
 EndProcedure
; *********************************************************************
Procedure DBLockVertexDataForLimbEx( ObjectNumber.l, LimbNumber.l, Mode.l )
  CallCFunctionFast( *DB_Basic3D\LockVertexDataForLimbEx, ObjectNumber, LimbNumber, Mode.l )
 EndProcedure
;
; *********************************************************************
Procedure DBSetVertexDataPosition( VertexID.l, XPos.f, YPos.f, ZPos.f )
  FXPos.l = 0 : FYPos.l = 0 : FZPos.l = 0
  PokeF( @FXPos, XPos ) : PokeF( @FYPos, YPos ) : PokeF( @FZPos, ZPos )
  CallCFunctionFast( *DB_Basic3D\SetVertexDataPosition, VertexID, FXPos, FYPos, FZPos )
 EndProcedure
;
; *********************************************************************
