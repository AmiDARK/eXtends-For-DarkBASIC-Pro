...
Procedure.s DBAppname()
  Retour.l = CallCFunctionFast( *DB_File\Appname, 0 )
  If Retour <> 0
...
Procedure.s DBWindir()
  Retour.l = CallCFunctionFast( *DB_File\Windir, 0 )
  If Retour <> 0
    RetourSTR.s = PeekS( Retour )
    CallCFunctionFast( *GlobPtr\CreateDeleteString, Retour, 0 )
   Else
...
;  Retour.l = CallCFunctionFast( *DB_File\GetDir, 0 )
;  If Retour <> 0
;    RetourSTR.s = PeekS( Retour )
;    CallCFunctionFast( *GlobPtr\CreateDeleteString, Retour, 0 )
;   Else
;    RetourSTR = ""
;   EndIf
  RetourSTR.s = GetCurrentDirectory()
  ProcedureReturn RetourSTR
 EndProcedure
;
; *********************************************************************
Procedure.s DBGetFileDate()
  Retour.l = CallCFunctionFast( *DB_File\GetFileDate, 0 )
  If Retour <> 0
    RetourSTR.s = PeekS( Retour )
    CallCFunctionFast( *GlobPtr\CreateDeleteString, Retour, 0 )
   Else
...
Procedure.s DBGetFileName()
  Retour.l = CallCFunctionFast( *DB_File\GetFileName, 0 )
  If Retour <> 0
    RetourSTR.s = PeekS( Retour )
    CallCFunctionFast( *GlobPtr\CreateDeleteString, Retour, 0 )
   Else
...
Procedure DBWriteFloat( FileNumber.l, Variable.f )
  V.l = 0 : PokeF( @V, Variable )
  CallCFunctionFast( *DB_File\WriteFloat, FileNumber, V )
 EndProcedure
;
; *********************************************************************
...
Procedure.s DBGetFileCreation()
  Retour.l = CallCFunctionFast( *DB_File\GetFileCreation, 0 )
  If Retour <> 0
    RetourSTR.s = PeekS( Retour )
    CallCFunctionFast( *GlobPtr\CreateDeleteString, Retour, 0 )
   Else
...
Procedure.s DBReadFilemapString( Param1.s )
  ...
  Retour.l = CallCFunctionFast( *DB_File\ReadFilemapString, 0, Param1PTR )
  If Retour <> 0
    RetourSTR.s = PeekS( Retour )
    CallCFunctionFast( *GlobPtr\CreateDeleteString, Retour, 0 )
   Else
