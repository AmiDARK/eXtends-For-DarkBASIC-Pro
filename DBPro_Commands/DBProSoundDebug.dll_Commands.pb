...
Procedure DBPositionSound( SoundNumber.l, X.f, Y.f, Z.f )
  ...
  CallCFunctionFast( *DB_Sound\PositionSound, SoundNumber, X1, Y1, Z1 )
 EndProcedure
;
; *********************************************************************
Procedure DBPositionListener( X.f, Y.f, Z.f )
  X1.l = 0 : Y1.l = 0 : Z1.l = 0
  PokeF( @X1, X ) : PokeF( @Y1, Y ) : PokeF( @Z1, Z )
  CallCFunctionFast( *DB_Sound\PositionListener, X1, Y1, Z1 )
 EndProcedure
;
; *********************************************************************
...
Procedure DBRotateListener( X.f, Y.f, Z.f )
  X1.l = 0 : Y1.l = 0 : Z1.l = 0
  PokeF( @X1, X ) : PokeF( @Y1, Y ) : PokeF( @Z1, Z )
  CallCFunctionFast( *DB_Sound\RotateListener, X1, Y1, Z1 )
 EndProcedure
;
; *********************************************************************
...
Procedure DBScaleListener( ScalingFactor.f )
  SF.l = 0 : PokeF( @SF, ScalingFactor )
  CallCFunctionFast( *DB_Sound\ScaleListener, SF )
 EndProcedure
;
; *********************************************************************
