...
Procedure DBMakeMatrix( MatrixNumber.l, Width.f, Height.f, XSegments.l, ZSegments.l )
  ...
  CallCFunctionFast( *DB_Matrix\MakeEx, MatrixNumber, W, H, XSegments, ZSegments )
 EndProcedure
;
; *********************************************************************
...
Procedure DBPositionMatrix( MatrixNumber.l, X.f, Y.f, Z.f )
  ...
  CallCFunctionFast( *DB_Matrix\PositionEx, MatrixNumber, X1, Y1, Z1 )
 EndProcedure
;
; *********************************************************************
...
Procedure DBSetMatrixHeight( MatrixNumber.l, TileX.l, TileZ.l, Height.f )
  ...
  CallCFunctionFast( *DB_Matrix\SetHeight, MatrixNumber, TileX, TileZ, H )
 EndProcedure
;
; *********************************************************************
Procedure DBSetMatrixNormal( MatrixNumber.l, TileX.l, TileZ.l, NX.f, NY.f, NZ.f )
  ...
  CallCFunctionFast( *DB_Matrix\SetNormal, MatrixNumber, TileX, TileZ, NX1, NY1, NZ1 )
 EndProcedure
;
; *********************************************************************
...
Procedure.f DBGetGroundHeight( MatrixNumber.l, X.f, Z.f )
  ...
  Retour.l = CallCFunctionFast( *DB_Matrix\GetGroundHeightEx, MatrixNumber, X1, Z1 )
...
Procedure DBSetMatrixTrim( MatrixNumber.l, TrimX.f, TrimY.f )
  X1.l = 0 : Y1.l = 0
  PokeF( @X1, TrimX ) : PokeF( @Y1, TrimY )
  CallCFunctionFast( *DB_Matrix\SetTrim, MatrixNumber, X1, Y1 )
 EndProcedure
;
; *********************************************************************
