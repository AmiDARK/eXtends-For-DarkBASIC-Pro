...
;
  Global SNDInitialized.l

;
; *************************************************************************************** Start()
ProcedureCDLL AConstructor00YAXXZ()
  If SNDInitialized = 0
    SNDInitialized = InitDLLBase()
   EndIf
...
ProcedureCDLL.s AGetDependencyID00YAPBDH0Z( NumID.l )
 ...
 EndProcedure
; **************************************************************
ProcedureCDLL.l SND_Init()
  If SNDInitialized = 0
    SNDInitialized = InitDLLBase()
   EndIf
  If *GlobPtr = 0 : InitialiseCorePtr() : EndIf
  ProcedureReturn SNDInitialized 
 EndProcedure
;
; ************************************************************** Files updated To handle : .s = MyDeleteString( .l )
; **************************************************************
  IncludeFile "DBProSoundDynamic.pb"
; **************************************************************
; **************************************************************
DataSection
DEP_eXtends:
...
Data.s "DBProSoundExtends.dll Ver 1.6 [ 2012.06.27 ]  / "
...
; FirstLine = 37
; Folding = -
; Executable = eXtends_Sounds.dll
; AddResource = Sounds.rc