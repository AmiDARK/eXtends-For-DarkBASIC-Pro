...
ProcedureCDLL AConstructor00YAXXZ()
  If V3D4Initialized = 0
    V3D4Initialized = InitDLLBase()
   EndIf
...
ProcedureCDLL.s AGetDependencyID00YAPBDH0Z( NumID.l )
 ...
 EndProcedure
; **************************************************************
ProcedureCDLL.l Vector4_Init()
  If V3D4Initialized = 0
    V3D4Initialized = InitDLLBase()
   EndIf
  If *GlobPtr = 0 : InitialiseCorePtr() : EndIf
  ProcedureReturn V3D4Initialized
 EndProcedure
; **************************************************************
IncludeFile "DBProVector4Dynamic.pb"
; **************************************************************
; **************************************************************
DataSection
DEP_eXtends:
...
Data.s "DBProVector4Extends.dll Ver 1.6 [ 2012.06.27 ]  / "
...
; FirstLine = 39
; Folding = -
; Executable = eXtends_Vectors4_3D.dll
; AddResource = Vector4.rc