...
ProcedureCDLL AConstructor00YAXXZ()
  If V3D2Initialized = 0
    V3D2Initialized = InitDLLBase()
   EndIf
...
ProcedureCDLL.l Vector2_Init()
 ...
 EndProcedure
; **************************************************************
IncludeFile "DBProVector2Dynamic.pb"
; **************************************************************
; **************************************************************
DataSection
DEP_eXtends:
...
Data.s "DBProVector2Extends.dll Ver 1.6 [ 2012.06.27 ]  / "
...
; FirstLine = 38
; Folding = -
; Executable = eXtends_Vectors2_3D.dll
; AddResource = Vector2.rc