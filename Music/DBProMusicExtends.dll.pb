...
;
  Global MSCInitialized.l

;
; *************************************************************************************** Start()
ProcedureCDLL AConstructor00YAXXZ()
  If MSCInitialized = 0
    MSCInitialized = InitDLLBase()
   EndIf
...
ProcedureCDLL.s AGetDependencyID00YAPBDH0Z( NumID.l )
 ...
 EndProcedure
; **************************************************************
ProcedureCDLL.l MSC_Init()
  If MSCInitialized = 0
    MSCInitialized = InitDLLBase()
   EndIf
  If *GlobPtr = 0 : InitialiseCorePtr() : EndIf
  ProcedureReturn MSCInitialized 
 EndProcedure
;
; ************************************************************** Files updated To handle : .s = MyDeleteString( .l )
; **************************************************************
  IncludeFile "DBProMusicDynamic.pb"
; **************************************************************
; **************************************************************
DataSection
DEP_eXtends:
...
Data.b 0
DEP_DBPRO01:
Data.s "DBProMusicDebug.dll"
Data.b 0
DONNEES:
Data.s "DarkBasic Professional Extends Pack Ver 1.6 / "
Data.s "DBProMusicExtends.dll Ver 1.6 [ 2012.06.27 ]  / "
...
; FirstLine = 34
; Folding = -
; Executable = eXtends_Musics.dll
; DisableDebugger
; AddResource = Music.rc