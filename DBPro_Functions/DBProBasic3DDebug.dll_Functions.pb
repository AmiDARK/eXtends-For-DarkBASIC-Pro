...
Procedure.l CheckBasic3D()
  ...
  If OpenLibrary( 1, "DBProBasic3DDebug.dll")
    ...
    ; New Functions from eXtends 1.6
    DB_Basic3D\PerformChecklistForObjectLimbs = AIsFunction( 1, "?PerformCheckListForLimbs@@YAXH@Z" ) ;
    DB_Basic3D\LockVertexDataForLimb = AIsFunction( 1, "?LockVertexDataForLimb@@YAXHH@Z" ) ;
    DB_Basic3D\LockVertexDataForLimbEx = AIsFunction( 1, "?LockVertexDataForLimbCore@@YAXHHH@Z" ) ;
    DB_Basic3D\SetVertexDataPosition = AIsFunction( 1, "?SetVertexDataPosition@@YAXHMMM@Z" ) ;  
  Else
    SUCCESS.l = 0
   EndIf
